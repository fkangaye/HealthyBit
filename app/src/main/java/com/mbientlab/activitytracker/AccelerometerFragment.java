...
//
//
//    public void enableFilterOutput(MetaWearController mwCtrllr) {
//        final DataProcessor dpCtrllr= (DataProcessor) mwController.getModuleController(Module.DATA_PROCESSOR);
//
//        mwCtrllr.addModuleCallback(new DataProcessor.Callbacks() {
//            @Override
//            public void receivedFilterOutput(byte filterId, byte[] output) {
//                if (filterId == timeFilterId) {
//                    ///< On firmware v1.0 and later, accelerometer data is returned
//                    ///< in milliGs.  Since we requested the output to be 4 bytes,
//                    ///< we will use the getInt method as opposed to getShort
//                    int activityMilliG = ByteBuffer.wrap(output)
//                            .order(ByteOrder.LITTLE_ENDIAN).getInt();
//
//                    long offset;
//                    if (start == -1) {
...
//                    }
//                    Log.i("ActivityTracker", String.format(Locale.US, "%.3f,%.3f",
//                            offset / 1000.0, activityMilliG / 1000.0));
//                }
//            }
//        });
//
//        ///< Enable notifications on the time delay filter
//        dpCtrllr.enableFilterNotify(timeFilterId);
//    }
